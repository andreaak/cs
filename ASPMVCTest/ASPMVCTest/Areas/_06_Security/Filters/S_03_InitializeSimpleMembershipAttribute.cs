...
using _01_ASPMVCTest.Areas.S_06_Security.Models;

namespace _01_ASPMVCTest.Areas.S_06_Security.Filters
{
    [AttributeUsage(AttributeTargets.Class | AttributeTargets.Method, AllowMultiple = false, Inherited = true)]
    public sealed class S_03_InitializeSimpleMembershipAttribute : ActionFilterAttribute
    {
        ...
        private class SimpleMembershipInitializer
        {
            public SimpleMembershipInitializer()
            {
                ...
                try
                {
                    ...
                    WebSecurity.InitializeDatabaseConnection("local", "UserProfile", "UserId", "UserName", autoCreateTables: true);
