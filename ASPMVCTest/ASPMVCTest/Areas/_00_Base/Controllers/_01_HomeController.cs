...
using _01_ASPMVCTest.Areas._00_Base.Models;

namespace _01_ASPMVCTest.Areas._00_Base.Controllers
{
    public class _01_HomeController : Controller
    {
        ...
        */
        ...
        public ActionResult B_01_BaseInfo()
        {
            return View();
        }

        public ActionResult B_02_Products()
        {
            ...
            /*
            Возвращаем представление из директории Views/_01_Home/B_02_Products.cshtml
