...
{
    public class TranslateDeRuVerbFormsParser : LanguageParser, ILanguageParser
    {
        public TranslateDeRuVerbFormsParser()
        ...
        private IrrVerb GetPartClass(string line)
        {
            ...
            return factory.GetIrregularVerb(items[0]);
