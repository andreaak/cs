...
{
    public class KonjunktivIFuturIIVerbFormParser : BaseVerbFormParser
    {
        private const string PREFFIX = "KONJUNKTIV_I_FUTUR_II";

        protected override VerbForm VerbForm => VerbForm.KonjunktivIFuturII;
