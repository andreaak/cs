...
{
    public class FuturIIVerbFormParser : BaseVerbFormParser
    {
        private const string PREFFIX = "INDIKATIV_FUTUR_II";

        protected override VerbForm VerbForm => VerbForm.FuturII;
