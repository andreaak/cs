...
{
    public static class BrowsersRepository
    {
        ...
        public static List<BrowserInfo> Browsers
        {
            get
            {
                if (_browsers == null)
                {
                    ...
                    info.ImagePath = "./Images/chrome.png";
                    ...
                    info.ImagePath = "./Images/internet_explorer.png";
                    ...
                    info.ImagePath = "./Images/mozilla.png";
                    ...
                    info.ID = 4;
                    info.Name = "Opera";
                    info.ImagePath = "./Images/opera.png";
                    ...
                    info.ID = 5;
                    info.Name = "Safari";
                    info.ImagePath = "./Images/safari.png";
