<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="03_MultipleValueBinding.aspx.cs" Inherits="ASPWebFormsTest._08_DataBinding._03_MultipleValueBinding" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Множественная привязка данных</title>
...
<body>
    ...
    <p>
        ...
        <br />
        <span class="bold">DataBind()</span> - метод, который запускает механизм привязки данных
    </p>
    <p class="code">
    ...
    <table>
        ...
        <tr>
            ...
            <td>Данное свойство подобное DataTextField 
                но устанавливает источник для value элемента в списке</td>
        </tr>
    </table>
    <br/>
    <br/>
