    ...
    public class Global : HttpApplication
    {
        ...
        private void RegisterRoutes(RouteCollection routes)
        {
            ...
            */
            ...
            переписывать настройки ссылок в приложении не прийдеться.
            */
        ...
        /*
        Данный метод вызывается для того, чтобы получить ключ, 
        который будет использоваться для кэширования результата текущего запроса.
        На каждое значение возвращаемое данным методом будет создана запись в кэш, 
        если кэш уже содержит запись по ключу,
        то будет использоваться кэшированное значение.
        */
        public override string GetVaryByCustomString(HttpContext context, string custom)
        {
            if (custom == "device")
            {
                ...
                В данном приложении ответ будет кэшироваться 
