...
<body>
    ...
    <p>
        <span class="bold">PreInit</span> - происходит на ранней стадии жизненного цикла страницы. 
    ...
    <p>
        <span class="bold">Init</span> - происходит при инициализации серверного элемента управления или страницы, 
    ...
    <p>
        <span class="bold">InitComplete</span> - происходит при завершении инициализации. 
    ...
    <p>
        <span class="bold">PreLoad</span> - происходит после обработки всех данных полученных от пользователя 
    ...
    <p>
        <span class="bold">Load</span> - событие указывает на то, что страница загружена 
    ...
    <p>
        <span class="bold">LoadComplete</span> - Происходит в конце этапа загрузки страницы. 
    ...
    <p>
        <span class="bold">PreRender</span> - происходит перед тем 
    ...
    <p>
        <span class="bold">PreRenderComplete</span> - происходит после того как все элементы управления 
    ...
    <p>
        <span class="bold">SaveStateComplete</span> - Завершение сохранение ViewState.
    </p>
    <div class="description">
        Используется для:
        <ul>
    ...
    <p>
        <span class="bold">Unload</span> - происходит при очистке объекта и выгрузки его из оперативной памяти.
        <br />
