...
namespace CSTest._12_MultiThreading._07_AsyncAwait._0_Setup
{
    class _10_ClassUnderTestReflected
    {
        ...
        {
            _10_ClassUnderTestReflected.AsyncStateMachine stateMachine = new AsyncStateMachine();
        ...
        {
            _10_ClassUnderTestReflected.AsyncStateMachine5ReturnValue stateMachine = new AsyncStateMachine5ReturnValue();
            stateMachine.outer = this;
            stateMachine.builder = AsyncVoidMethodBuilder.Create();
            stateMachine.state = -1;
            stateMachine.builder.Start(ref stateMachine);//builder вызывает MoveNext()
