...
{
    [TestFixture]
    public class _01_WinFormsWPFTest
    {
        [Test]
        public void TestWinFormsWPF1UseSynchronizationContext()
        {
        ...
        public void TestWinFormsWPF2TaskContinue()
        {
        ...
        public void TestWinFormsWPF3TaskContinueCancel()
        {
            Debug.WriteLine("Основной поток запущен.");
            UIContext.Initialize();
            CancellationTokenSource cts = new CancellationTokenSource();
        ...
        public void TestWinFormsWPF4TaskContinueException()
        {
            Debug.WriteLine("Основной поток запущен.");
            Debug.WriteLine("Первичный поток: Id {0}", Thread.CurrentThread.ManagedThreadId);
            UIContext.Initialize();
        ...
        [Test]
        public void TestWinFormsWPF5AsyncAwait()
        {
        ...
        [Test]
        public void TestWinFormsWPF6AsyncAwaitException()
        {
            NewMethod();
        }
