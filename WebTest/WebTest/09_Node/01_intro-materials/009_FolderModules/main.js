/* Алгоритм поиска модулей при вызыове функции require('имя_модуля')
     ...
     1. Если 'имя_модуля' соответствует имени директории и в ней есть файл package.json, происходит парсинг содержимого в объект 
...
//require('./custom'); // folder with package.json

require('custom'); // node_modules 
