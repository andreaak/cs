    ...
    class MazeFactory
    {
        ...
        public static MazeFactory Instance()
        {
            if (instance == null)
            {
                ...
                {
                    System.Diagnostics.Debug.WriteLine("Инстанцируем фабрику для лабиринта с бомбами");
                    instance = new BombedMazeFactory();
                }
                else if (string.Compare(mazeStyle, "enchanted") == 0)
                {
                    System.Diagnostics.Debug.WriteLine("Инстанцируем фабрику для лабиринта с заклинаниями");
                    instance = new EnchantedMazeFactory();
                }
                else // По умолчанию.
                {
                    System.Diagnostics.Debug.WriteLine("Инстанцируем фабрику для обычного лабиринта");
