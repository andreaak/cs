    ...
    class StandardMazeBuilder : MazeBuilder
    {
        ...
        private Direction CommonWall(Room.Room room1, Room.Room room2)
        {
            if (room1.GetSide(Direction.North) is Wall.Wall &&
                ...
                room2.GetSide(Direction.North) is Wall.Wall &&
                room2.GetSide(Direction.South) is Wall.Wall &&
                room2.GetSide(Direction.East) is Wall.Wall &&
                room2.GetSide(Direction.West) is Wall.Wall)
            {
