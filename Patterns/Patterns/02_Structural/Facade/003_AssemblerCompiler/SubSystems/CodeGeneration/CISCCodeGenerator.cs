...
namespace Patterns._02_Structural.Facade._003_AssemblerCompiler.SubSystems.CodeGeneration
{
    class CISCCodeGenerator : CodeGenerator
    {
        ...
        {
            Array.Copy((Array) StaticData, (int) 0, (Array) Data, (int) 0, (int) StaticData.Length);
        ...
        public override void SetDataVariable(VariableNode node)
        {
            ...
            Array.Copy((Array) bytes.ToArray(), (int) 0, (Array) Data, (int) dataPointer, 4);
        ...
        {
            StatementNode exitProcess = Enumerable.Where<StatementNode>(functions, x => x.Name == "ExitProcess").FirstOrDefault();
            StatementNode hexMessage = Enumerable.Where<StatementNode>(functions, x => x.Name == "HexMessage").FirstOrDefault();
        ...
        public override ByteCode GenerateByteCode()
        {
            ...
            return new ByteCode(Enumerable.Concat<byte>(Header, Body).Concat(ImportTable).Concat(Data).ToArray());
        }
        #endregion    
    }
}
