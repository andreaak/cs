...
namespace CSTest._25_CS_NewFeatures._01_CS4._01_Lazy
{
    ...
    public class LazyNET<T>
    {
        ...
        /// An instance created with this constructor may be used concurrently from multiple threads.
        /// </remarks>
        public LazyNET(Func<T> valueFactory)
        ...
        /// </param>
        public LazyNET(bool isThreadSafe) :
        ...
        public LazyNET(LazyThreadSafetyMode mode)
        {
        ...
        public LazyNET(Func<T> valueFactory, bool isThreadSafe)
        ...
        public LazyNET(Func<T> valueFactory, LazyThreadSafetyMode mode)
        {
    ...
    internal sealed class System_LazyDebugView<T>
    {
        ...
        private readonly LazyNET<T> m_lazy;
        ...
        public System_LazyDebugView(LazyNET<T> lazy)
        {
            m_lazy = lazy;
        }
