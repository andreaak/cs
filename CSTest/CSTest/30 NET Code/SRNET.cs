...
namespace CSTest._30_NET_Code
{
    internal sealed class SRNET
    {
        ...
        public static ResourceManager Resources
        {
            get
            {
                return SRNET.GetLoader().resources;
            }
        }
        ...
        private static SRNET GetLoader()
        {
            if (SRNET.loader == null)
            {
                SRNET sr = new SRNET();
                Interlocked.CompareExchange<SRNET>(ref SRNET.loader, sr, (SRNET)null);
            }
            return SRNET.loader;
        }
        ...
        {
            SRNET loader = SRNET.GetLoader();
            if (loader == null)
                return (string)null;
            string @string = loader.resources.GetString(name, SRNET.Culture);
        ...
        public static string GetString(string name)
        {
            ...
            if (loader == null)
                return (string)null;
            return loader.resources.GetString(name, SRNET.Culture);
        }

        public static string GetString(string name, out bool usedFallback)
        {
            usedFallback = false;
            return SRNET.GetString(name);
        }
        ...
        public static object GetObject(string name)
        {
            ...
            if (loader == null)
                return (object)null;
            return loader.resources.GetObject(name, SRNET.Culture);
        }
    }
}
