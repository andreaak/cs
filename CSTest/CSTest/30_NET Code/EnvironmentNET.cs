...
namespace CSTest._30_NET_Code
{
    public class EnvironmentNET
    {
        ...
        internal static string GetResourceString(string v, object key, Type targetType)
        {
            return string.Empty;
        }
...
//    [ComVisible(true)]
//    public static class EnvironmentNET
//    {
...
//                {
//                    Contract.Assert(false, "EnvironmentNET::GetResourceString with null or empty key.  Bug in caller, or weird recursive loading problem?");
...
//                    EnvironmentNET.FailFast(message);
//                }
...
//                Contract.Assert(s != null, "Managed resource string lookup failed.  Was your resource name misspelled?  Did you rebuild mscorlib after adding a resource to resources.txt?  Debug this w/ cordbg and bug whoever owns the code that called EnvironmentNET.GetResourceString.  Resource name was: \"" + key + "\"");
...
////            {
////                // EnvironmentNET variable accessors are not approved modern API.
...
////                    if (fJustExpanded)
////                    { // We expanded successfully, we need to do String comparison here
...
//        //            throw new InvalidOperationException(EnvironmentNET.GetResourceString("InvalidOperation_ComputerName"));
//        //        return buf.ToString();
//        //    }
//        //}
...
//            {
//                return null; //GetEnvironmentVariable(variable);
//            }
...
//                       Registry.LocalMachine.OpenSubKey(@"System\CurrentControlSet\Control\Session Manager\EnvironmentNET", false)) {

//                   Contract.Assert(environmentKey != null, @"HKLM\System\CurrentControlSet\Control\Session Manager\EnvironmentNET is missing!");
...
//                using (RegistryKey environmentKey = 
//                       Registry.CurrentUser.OpenSubKey("EnvironmentNET", false)) {

//                   Contract.Assert(environmentKey != null, @"HKCU\EnvironmentNET is missing!");
//                   if (environmentKey == null) {
//                       return null; 
//                   }
...
//            {
//                throw new ArgumentException(EnvironmentNET.GetResourceString("Arg_EnumIllegalVal", (int)target));
//            }
//        }
//#endif
...
////                    // See the description of EnvironmentNET Blocks in MSDN's
...
////            // Read docs about EnvironmentNET Blocks on MSDN's CreateProcess page.
...
//            if (target == EnvironmentVariableTarget.Process)
//            {
//                return null; //GetEnvironmentVariables();
//            }
...
////                {
////                    throw new ArgumentException(EnvironmentNET.GetResourceString("Argument_LongEnvVarValue"));
////                }
////            }
...
//            {
//                throw new ArgumentException(EnvironmentNET.GetResourceString("Argument_StringZeroLength"), "variable");
//            }

//            if (variable[0] == '\0')
//            {
//                throw new ArgumentException(EnvironmentNET.GetResourceString("Argument_StringFirstCharIsZero"), "variable");
//            }
...
//            {
//                throw new ArgumentException(EnvironmentNET.GetResourceString("Argument_IllegalEnvVarName"));
//            }
//            Contract.EndContractBlock();
//        }
...
//            {
//                throw new ArgumentException(EnvironmentNET.GetResourceString("Argument_LongEnvVarName"));
//            }
...
//            if( target == EnvironmentVariableTarget.Machine) {
//                using (RegistryKey environmentKey = 
//                       Registry.LocalMachine.OpenSubKey(@"System\CurrentControlSet\Control\Session Manager\EnvironmentNET", true)) {
...
//                }
//                using (RegistryKey environmentKey = 
//                       Registry.CurrentUser.OpenSubKey("EnvironmentNET", true)) {
//                   Contract.Assert(environmentKey != null, @"HKCU\EnvironmentNET is missing!");
//                   if (environmentKey != null) {
//                      if (value == null)
//                          environmentKey.DeleteValue(variable, false);
...
//            IntPtr r = Win32Native.SendMessageTimeout(new IntPtr(Win32Native.HWND_BROADCAST), Win32Native.WM_SETTINGCHANGE, IntPtr.Zero, "EnvironmentNET", 0, 1000, IntPtr.Zero);
...
////                    if (!GetVersion(osvi))
////                    {
////                        throw new InvalidOperationException(EnvironmentNET.GetResourceString("InvalidOperation_GetVersion"));
////                    }
...
//        //        {
//        //            OperatingSystem OS = EnvironmentNET.OSVersion;
...
//                Monitor.Enter(EnvironmentNET.InternalSyncObject, ref tookLock);
...
//            {
//                if (tookLock)
//                    Monitor.Exit(EnvironmentNET.InternalSyncObject);
//            }
//        }
...
//        //        throw new ArgumentException(EnvironmentNET.GetResourceString("Arg_EnumIllegalVal", (int)folder));
//        //    Contract.EndContractBlock();
...
//        //        throw new ArgumentException(EnvironmentNET.GetResourceString("Arg_EnumIllegalVal", (int)option));
//        //    Contract.EndContractBlock();
...
////        //////!!!!!! 2) ndp\clr\src\BCL\System\EnvironmentNET.cs             !!!!!!////////
