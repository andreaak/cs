...
{
    [Serializable]
    public sealed class StringBuilder2
    {
        // A StringBuilder2 is internally represented as a linked list of blocks each of which holds
        ...
        internal StringBuilder2 m_ChunkPrevious;      // Link to the block logically before this block
        ...
        // Creates an empty StringBuilder2 with a minimum capacity of capacity
        ...
        private StringBuilder2(SerializationInfo info, StreamingContext context) {
            if (info == null)
            ...
            if (!capacityPresent) {
                // StringBuilder2 in V1.X did not persist the Capacity, so this is a valid legacy code path.
        ...
        private void VerifyClassInvariant()
        {
            ...
            StringBuilder2 currentBlock = this;
            ...
            for (; ; )
            {
                ...
                StringBuilder2 prevBlock = currentBlock.m_ChunkPrevious;
                if (prevBlock == null)
                {
        ...
        // instance, the StringBuilder2 is truncated.  If length is greater than the current 
        ...
        public int Length
        {
            ...
            set
            {
                ...
                if (delta > 0)
                {
                    // the end of the string value of the current StringBuilder2 object is padded with the Unicode NULL character
                ...
                {
                    StringBuilder2 chunk = FindChunkForIndex(value);
                    if (chunk != this)
                    {
        ...
        public StringBuilder2 Append(char value, int repeatCount)
        {
            ...
            Contract.Ensures(Contract.Result<StringBuilder2>() != null);
            Contract.EndContractBlock();
        ...
        **
        ...
        // Returns a reference to the StringBuilder2 with ; value inserted into 
        ...
        // Returns a reference to the StringBuilder2 with charCount characters from 
        // value inserted into the buffer at index.  Existing characters are shifted
        // to make room for the new text and capacity is adjusted as required.  If value is null, the StringBuilder2
        ...
        // StringBuilder2 is not changed. No changes are made if value is null.
        // 
        ...
        public StringBuilder2 AppendFormat(IFormatProvider provider, String format, Object arg0)
        {
            Contract.Ensures(Contract.Result<StringBuilder2>() != null);
            return AppendFormatHelper(provider, format, arg0);
        }

        public StringBuilder2 AppendFormat(IFormatProvider provider, String format, Object arg0, Object arg1)
        {
            Contract.Ensures(Contract.Result<StringBuilder2>() != null);
            return AppendFormatHelper(provider, format, arg0, arg1);
        }

        public StringBuilder2 AppendFormat(IFormatProvider provider, String format, Object arg0, Object arg1, Object arg2)
        {
            Contract.Ensures(Contract.Result<StringBuilder2>() != null);
        ...
        internal StringBuilder2 AppendFormatHelper(IFormatProvider provider, String format, params Object[] args)
        {
            if (format == null)
            {
        ...
        // Returns a reference to the current StringBuilder2 with all instances of oldString 
        ...
        public bool Equals(StringBuilder2 sb)
        {
            if (sb == null)
                return false;
            ...
            StringBuilder2 thisChunk = this;
            int thisChunkIndex = thisChunk.m_ChunkLength;
            StringBuilder2 sbChunk = sb;
            int sbChunkIndex = sbChunk.m_ChunkLength;
            for (; ; )
            {
                // Decrement the pointer to the 'this' StringBuilder2
                --thisChunkIndex;
                --sbChunkIndex;
        ...
        public StringBuilder2 Replace(String oldValue, String newValue, int startIndex, int count)
        {
            ...
            StringBuilder2 chunk = FindChunkForIndex(startIndex);
        ...
        // Returns a StringBuilder2 with all instances of oldChar replaced with 
        // newChar.  The size of the StringBuilder2 is unchanged because we're only
        ...
        /// <summary>
        /// Appends 'value' of length 'count' to the StringBuilder2. 
        /// </summary>
        [SecurityCritical]
        [System.CLSCompliantAttribute(false)]


        private StringBuilder2 Append2(string value)
        {
            return Append2(value, value.Length);
        }

        private StringBuilder2 Append2(string value, int startIndex, int valueCount)
        {
            return Append2(value.Substring(startIndex), valueCount);
        }

        public StringBuilder2 Append2(string value, int valueCount)
        {
        ...
        //public unsafe StringBuilder2 Append(char* value, int valueCount)
        //{
        //    // We don't check null value as this case will throw null reference exception anyway
        //    if (valueCount < 0)
        //    {
        ...
        /// </summary>
        [System.Security.SecuritySafeCritical]  // auto-generated
        private void ReplaceAllInChunk(int[] replacements, int replacementsCount, StringBuilder2 sourceChunk, int removeCount, string value)
        {
            ...
            //        StringBuilder2 targetChunk = sourceChunk;        // the target as we copy chars down
        ...
        /// </summary>
        private bool StartsWith(StringBuilder2 chunk, int indexInChunk, int count, string value)
        {
        ...
        /// </summary>
        //[SecurityCritical]
        //unsafe private void ReplaceInPlaceAtChunk(ref StringBuilder2 chunk, ref int indexInChunk, char* value, int count)
        //{
        //    if (count != 0)
        //    {
        //        for (; ; )
        ...
        //// Copies the source StringBuilder2 to the destination IntPtr memory allocated with len bytes.
        //[System.Security.SecurityCritical]  // auto-generated
        ...
        //    StringBuilder2 currentSrc = FindChunkForByte(len);
        ...
        /// <summary>
        /// Finds the chunk for the logical index (number of characters in the whole StringBuilder2) 'index'
        /// YOu can then get the offset in this chunk by subtracting the m_BlockOffset field from 'index' 
        /// </summary>
        /// <param name="index"></param>
        /// <returns></returns>
        private StringBuilder2 FindChunkForIndex(int index)
        {
            Contract.Assert(0 <= index && index <= Length, "index not in string");

            StringBuilder2 ret = this;
        ...
        /// <param name="index"></param>
        /// <returns></returns>
        private StringBuilder2 FindChunkForByte(int byteIndex)
        {
        ...
        /// is a assumed to point at the chunk representing the whole StringBuilder2) and search
        /// until it finds the current chunk (thus is O(n)).  So it is more expensive than a field fetch!
        /// </summary>
        private StringBuilder2 Next(StringBuilder2 chunk)
        {
            if (chunk == this)
                return null;
        ...
        private void ExpandByABlock(int minBlockCharCount)
        {
            ...
            m_ChunkPrevious = new StringBuilder2(this);
        ...
        /// </summary>
        private StringBuilder2(StringBuilder2 from)
        {
        ...
        /// </summary>
        [System.Security.SecuritySafeCritical]  // auto-generated
        private void MakeRoom(int index, int count, out StringBuilder2 chunk, out int indexInChunk, bool doneMoveFollowingChars)
        {
            VerifyClassInvariant();
            ...
            StringBuilder2 newChunk = new StringBuilder2(Math.Max(count, DefaultCapacity), chunk.m_MaxCapacity, chunk.m_ChunkPrevious);
        ...
        /// </summary>
        private StringBuilder2(int size, int maxCapacity, StringBuilder2 previousBlock)
        {
        ...
        /// </summary>
        [SecuritySafeCritical]
        private void Remove(int startIndex, int count, out StringBuilder2 chunk, out int indexInChunk)
        {
            VerifyClassInvariant();
    ...
    public class Environment
    {
        ...
        internal static string GetResourceString(string p1, string p2)
        {
            return string.Empty;
        }
