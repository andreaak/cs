...
namespace CSTest._08_String._02_StringBuilder
{
    ...
    {
        // A StringBuilderNET is internally represented as a linked list of blocks each of which holds
        ...
        internal StringBuilderNET m_ChunkPrevious;      // Link to the block logically before this block
        ...
        public StringBuilderNET(int capacity)
        ...
        //  String.NullString).
        // 
        public StringBuilderNET(String value)
        ...
        // 
        public StringBuilderNET(String value, int capacity)
        ...
        public StringBuilderNET(String value, int startIndex, int length, int capacity)
        {
            if (capacity < 0)
            {
            ...
            ThreadSafeCopy(value, startIndex, m_ChunkChars, 0, length);
        }

        // Creates an empty StringBuilderNET with a minimum capacity of capacity
        // and a maximum capacity of maxCapacity.
        public StringBuilderNET(int capacity, int maxCapacity)
        {
        ...
        private StringBuilderNET(SerializationInfo info, StreamingContext context) {
            if (info == null)
            ...
            if (!capacityPresent) {
                // StringBuilderNET in V1.X did not persist the Capacity, so this is a valid legacy code path.
        ...
        private void VerifyClassInvariant()
        {
            ...
            StringBuilderNET currentBlock = this;
            ...
            for (; ; )
            {
                ...
                StringBuilderNET prevBlock = currentBlock.m_ChunkPrevious;
                if (prevBlock == null)
                {
        ...
        // instance, the StringBuilderNET is truncated.  If length is greater than the current 
        ...
        public int Length
        {
            ...
            set
            {
                ...
                if (delta > 0)
                {
                    // the end of the string value of the current StringBuilderNET object is padded with the Unicode NULL character
                ...
                {
                    StringBuilderNET chunk = FindChunkForIndex(value);
                    if (chunk != this)
                    {
        ...
        public StringBuilderNET Append(char value, int repeatCount)
        {
            if (repeatCount < 0)
            {
        ...
        [System.Security.SecuritySafeCritical]  // auto-generated
        public StringBuilderNET Append(char[] value, int startIndex, int charCount)
        {
        ...
        [System.Security.SecuritySafeCritical]  // auto-generated
        public StringBuilderNET Append(String value)
        {
            Contract.Ensures(Contract.Result<StringBuilderNET>() != null);
        ...
        [System.Security.SecuritySafeCritical]  // auto-generated
        public StringBuilderNET Append(String value, int startIndex, int count)
        {
            // in NetCF arguments pretty much don't matter as long as count is 0
            // we need to check this twice, as this is a contract area and we can't return from here
#if FEATURE_LEGACYNETCF
        ...
        [System.Runtime.InteropServices.ComVisible(false)]
        public StringBuilderNET AppendLine(string value)
        {
            Contract.Ensures(Contract.Result<StringBuilderNET>() != null);
            Append(value);
            return Append(Environment.NewLine);
        ...
        // 
        [System.Security.SecuritySafeCritical]  // auto-generated
        public StringBuilderNET Insert(int index, String value, int count)
        {
            if (count < 0)
            {
        ...
        // 
        public StringBuilderNET Remove(int startIndex, int length)
        {
            if (length < 0)
            {
                throw new ArgumentOutOfRangeException("length", Environment.GetResourceString("ArgumentOutOfRange_NegativeLength"));
        ...
        **
        ...
        public StringBuilderNET Append(bool value)
        {
            Contract.Ensures(Contract.Result<StringBuilderNET>() != null);
        ...
        // The capacity is adjusted as needed. 
        [CLSCompliant(false)]
        public StringBuilderNET Append(sbyte value)
        {
            Contract.Ensures(Contract.Result<StringBuilderNET>() != null);
        ...
        // The capacity is adjusted as needed. 
        public StringBuilderNET Append(byte value)
        {
            Contract.Ensures(Contract.Result<StringBuilderNET>() != null);
            return Append(value.ToString(CultureInfo.CurrentCulture));
        }
        ...
        // Appends a character at the end of this string builder. The capacity is adjusted as needed.
        public StringBuilderNET Append(char value)
        {
            Contract.Ensures(Contract.Result<StringBuilderNET>() != null);
        ...
        // The capacity is adjusted as needed. 
        public StringBuilderNET Append(short value)
        {
            Contract.Ensures(Contract.Result<StringBuilderNET>() != null);
            return Append(value.ToString(CultureInfo.CurrentCulture));
        }
        ...
        // The capacity is adjusted as needed. 
        public StringBuilderNET Append(int value)
        {
            Contract.Ensures(Contract.Result<StringBuilderNET>() != null);
            return Append(value.ToString(CultureInfo.CurrentCulture));
        }
        ...
        // The capacity is adjusted as needed. 
        public StringBuilderNET Append(long value)
        {
            Contract.Ensures(Contract.Result<StringBuilderNET>() != null);
            return Append(value.ToString(CultureInfo.CurrentCulture));
        }
        ...
        // The capacity is adjusted as needed. 
        public StringBuilderNET Append(float value)
        {
            Contract.Ensures(Contract.Result<StringBuilderNET>() != null);
            return Append(value.ToString(CultureInfo.CurrentCulture));
        }
        ...
        // The capacity is adjusted as needed. 
        public StringBuilderNET Append(double value)
        {
            Contract.Ensures(Contract.Result<StringBuilderNET>() != null);
            return Append(value.ToString(CultureInfo.CurrentCulture));
        }

        public StringBuilderNET Append(decimal value)
        {
            Contract.Ensures(Contract.Result<StringBuilderNET>() != null);
            return Append(value.ToString(CultureInfo.CurrentCulture));
        }
        ...
        // The capacity is adjusted as needed. 
        [CLSCompliant(false)]
        public StringBuilderNET Append(ushort value)
        {
            Contract.Ensures(Contract.Result<StringBuilderNET>() != null);
            return Append(value.ToString(CultureInfo.CurrentCulture));
        }
        ...
        // The capacity is adjusted as needed. 
        [CLSCompliant(false)]
        public StringBuilderNET Append(uint value)
        {
            Contract.Ensures(Contract.Result<StringBuilderNET>() != null);
            return Append(value.ToString(CultureInfo.CurrentCulture));
        }
        ...
        // The capacity is adjusted as needed. 
        [CLSCompliant(false)]
        public StringBuilderNET Append(ulong value)
        {
            Contract.Ensures(Contract.Result<StringBuilderNET>() != null);
            return Append(value.ToString(CultureInfo.CurrentCulture));
        }
        ...
        // The capacity is adjusted as needed. 
        public StringBuilderNET Append(Object value)
        {
            Contract.Ensures(Contract.Result<StringBuilderNET>() != null);
        ...
        **
        ...
        // Returns a reference to the StringBuilderNET with ; value inserted into 
        ...
        // StringBuilderNET is not changed.
        // 
        [System.Security.SecuritySafeCritical]  // auto-generated
        public StringBuilderNET Insert(int index, String value)
        {
        ...
        // StringBuilderNET is not changed.
        // 
        public StringBuilderNET Insert(int index, bool value)
        {
            Contract.Ensures(Contract.Result<StringBuilderNET>() != null);
        ...
        // 
        [CLSCompliant(false)]
        public StringBuilderNET Insert(int index, sbyte value)
        {
            Contract.Ensures(Contract.Result<StringBuilderNET>() != null);
        ...
        // StringBuilderNET is not changed.
        // 
        public StringBuilderNET Insert(int index, byte value)
        {
            Contract.Ensures(Contract.Result<StringBuilderNET>() != null);
            return Insert(index, value.ToString(CultureInfo.CurrentCulture), 1);
        }
        ...
        // StringBuilderNET is not changed.
        // 
        public StringBuilderNET Insert(int index, short value)
        {
            Contract.Ensures(Contract.Result<StringBuilderNET>() != null);
            return Insert(index, value.ToString(CultureInfo.CurrentCulture), 1);
        }
        ...
        // StringBuilderNET is not changed.
        [SecuritySafeCritical]
        public StringBuilderNET Insert(int index, char value)
        {
            Contract.Ensures(Contract.Result<StringBuilderNET>() != null);
        ...
        // Returns a reference to the StringBuilderNET with charCount characters from 
        // value inserted into the buffer at index.  Existing characters are shifted
        // to make room for the new text and capacity is adjusted as required.  If value is null, the StringBuilderNET
        // is unchanged.  Characters are taken from value starting at position startIndex.
        [System.Security.SecuritySafeCritical]  // auto-generated
        public StringBuilderNET Insert(int index, char[] value, int startIndex, int charCount)
        {
            Contract.Ensures(Contract.Result<StringBuilderNET>() != null);
        ...
        // StringBuilderNET is not changed.
        // 
        public StringBuilderNET Insert(int index, int value)
        {
            Contract.Ensures(Contract.Result<StringBuilderNET>() != null);
            return Insert(index, value.ToString(CultureInfo.CurrentCulture), 1);
        }
        ...
        // StringBuilderNET is not changed.
        // 
        public StringBuilderNET Insert(int index, long value)
        {
            Contract.Ensures(Contract.Result<StringBuilderNET>() != null);
            return Insert(index, value.ToString(CultureInfo.CurrentCulture), 1);
        }
        ...
        // StringBuilderNET is not changed.
        // 
        public StringBuilderNET Insert(int index, float value)
        {
            Contract.Ensures(Contract.Result<StringBuilderNET>() != null);
            return Insert(index, value.ToString(CultureInfo.CurrentCulture), 1);
        }
        ...
        // StringBuilderNET is not changed. 
        // 
        public StringBuilderNET Insert(int index, double value)
        {
            Contract.Ensures(Contract.Result<StringBuilderNET>() != null);
            return Insert(index, value.ToString(CultureInfo.CurrentCulture), 1);
        }

        public StringBuilderNET Insert(int index, decimal value)
        {
            Contract.Ensures(Contract.Result<StringBuilderNET>() != null);
            return Insert(index, value.ToString(CultureInfo.CurrentCulture), 1);
        }
        ...
        // 
        [CLSCompliant(false)]
        public StringBuilderNET Insert(int index, ushort value)
        {
            Contract.Ensures(Contract.Result<StringBuilderNET>() != null);
            return Insert(index, value.ToString(CultureInfo.CurrentCulture), 1);
        }
        ...
        // 
        [CLSCompliant(false)]
        public StringBuilderNET Insert(int index, uint value)
        {
            Contract.Ensures(Contract.Result<StringBuilderNET>() != null);
            return Insert(index, value.ToString(CultureInfo.CurrentCulture), 1);
        }
        ...
        // 
        [CLSCompliant(false)]
        public StringBuilderNET Insert(int index, ulong value)
        {
            Contract.Ensures(Contract.Result<StringBuilderNET>() != null);
            return Insert(index, value.ToString(CultureInfo.CurrentCulture), 1);
        }
        ...
        // StringBuilderNET is not changed. No changes are made if value is null.
        // 
        public StringBuilderNET Insert(int index, Object value)
        {
            Contract.Ensures(Contract.Result<StringBuilderNET>() != null);
        ...
        public StringBuilderNET AppendFormat(String format, Object arg0)
        {
            Contract.Ensures(Contract.Result<StringBuilderNET>() != null);
            return AppendFormatHelper(null, format, arg0);
        }

        public StringBuilderNET AppendFormat(String format, Object arg0, Object arg1)
        {
            Contract.Ensures(Contract.Result<StringBuilderNET>() != null);
            return AppendFormatHelper(null, format, arg0, arg1);
        }

        public StringBuilderNET AppendFormat(String format, Object arg0, Object arg1, Object arg2)
        {
            Contract.Ensures(Contract.Result<StringBuilderNET>() != null);
            return AppendFormatHelper(null, format, arg0, arg1, arg2);
        }

        public StringBuilderNET AppendFormat(String format, params Object[] args)
        {
            if (args == null)
            {
        ...
        public StringBuilderNET AppendFormat(IFormatProvider provider, String format, Object arg0)
        {
            Contract.Ensures(Contract.Result<StringBuilderNET>() != null);
            return AppendFormatHelper(provider, format, arg0);
        }

        public StringBuilderNET AppendFormat(IFormatProvider provider, String format, Object arg0, Object arg1)
        {
            Contract.Ensures(Contract.Result<StringBuilderNET>() != null);
            return AppendFormatHelper(provider, format, arg0, arg1);
        }

        public StringBuilderNET AppendFormat(IFormatProvider provider, String format, Object arg0, Object arg1, Object arg2)
        {
            Contract.Ensures(Contract.Result<StringBuilderNET>() != null);
            return AppendFormatHelper(provider, format, arg0, arg1, arg2);
        }

        public StringBuilderNET AppendFormat(IFormatProvider provider, String format, params Object[] args)
        {
            if (args == null)
            {
                // To preserve the original exception behavior, throw an exception about format if both
        ...
        // Returns a reference to the current StringBuilderNET with all instances of oldString 
        ...
        //
        public StringBuilderNET Replace(String oldValue, String newValue)
        {
            Contract.Ensures(Contract.Result<StringBuilderNET>() != null);
            return Replace(oldValue, newValue, 0, Length);
        }

        public bool Equals(StringBuilderNET sb)
        {
            if (sb == null)
                return false;
            ...
            StringBuilderNET thisChunk = this;
            int thisChunkIndex = thisChunk.m_ChunkLength;
            StringBuilderNET sbChunk = sb;
            int sbChunkIndex = sbChunk.m_ChunkLength;
            for (; ; )
            {
                // Decrement the pointer to the 'this' StringBuilderNET
                --thisChunkIndex;
                --sbChunkIndex;
        ...
        public StringBuilderNET Replace(String oldValue, String newValue, int startIndex, int count)
        {
            Contract.Ensures(Contract.Result<StringBuilderNET>() != null);
            ...
            StringBuilderNET chunk = FindChunkForIndex(startIndex);
        ...
        // Returns a StringBuilderNET with all instances of oldChar replaced with 
        // newChar.  The size of the StringBuilderNET is unchanged because we're only
        ...
        //
        public StringBuilderNET Replace(char oldChar, char newChar)
        {
            return Replace(oldChar, newChar, 0, Length);
        }
        public StringBuilderNET Replace(char oldChar, char newChar, int startIndex, int count)
        {
            Contract.Ensures(Contract.Result<StringBuilderNET>() != null);
        ...
        /// <summary>
        /// Appends 'value' of length 'count' to the StringBuilderNET. 
        /// </summary>
        [SecurityCritical]
        [System.CLSCompliantAttribute(false)]


        private StringBuilderNET Append2(string value)
        {
            return Append2(value, value.Length);
        }

        private StringBuilderNET Append2(string value, int startIndex, int valueCount)
        {
            return Append2(value.Substring(startIndex), valueCount);
        }

        public StringBuilderNET Append2(string value, int valueCount)
        {
        ...
        //public unsafe StringBuilderNET Append(char* value, int valueCount)
        //{
        //    // We don't check null value as this case will throw null reference exception anyway
        //    if (valueCount < 0)
        //    {
        ...
        /// </summary>
        [System.Security.SecuritySafeCritical]  // auto-generated
        private void ReplaceAllInChunk(int[] replacements, int replacementsCount, StringBuilderNET sourceChunk, int removeCount, string value)
        {
            ...
            //        StringBuilderNET targetChunk = sourceChunk;        // the target as we copy chars down
        ...
        /// </summary>
        private bool StartsWith(StringBuilderNET chunk, int indexInChunk, int count, string value)
        {
        ...
        /// </summary>
        //[SecurityCritical]
        //unsafe private void ReplaceInPlaceAtChunk(ref StringBuilderNET chunk, ref int indexInChunk, char* value, int count)
        //{
        //    if (count != 0)
        //    {
        //        for (; ; )
        ...
        private static void ThreadSafeCopy(string source, int sourceIndex, char[] destination, int destinationIndex, int count)
        {
            if (count > 0)
            {
                if ((destinationIndex + count) <= destination.Length)
                {
                    ...
                    ThreadSafeCopy(source.ToCharArray(), sourceIndex, destination, destinationIndex, count);
                    //fixed (char* destinationPtr = &destination[destinationIndex])
                    //    string.wstrcpy(destinationPtr, sourcePtr, count);
                }
                else
        ...
        private static void ThreadSafeCopy(char[] source, int sourceIndex, char[] destination, int destinationIndex, int count)
        {
            if (count > 0)
            {
                ...
                {
                    source.Skip(sourceIndex).Take(count).ToArray().CopyTo(destination, destinationIndex);
        ...
        //// Copies the source StringBuilderNET to the destination IntPtr memory allocated with len bytes.
        //[System.Security.SecurityCritical]  // auto-generated
        ...
        //    StringBuilderNET currentSrc = FindChunkForByte(len);
        ...
        /// <summary>
        /// Finds the chunk for the logical index (number of characters in the whole StringBuilderNET) 'index'
        /// YOu can then get the offset in this chunk by subtracting the m_BlockOffset field from 'index' 
        /// </summary>
        /// <param name="index"></param>
        /// <returns></returns>
        private StringBuilderNET FindChunkForIndex(int index)
        {
            Contract.Assert(0 <= index && index <= Length, "index not in string");

            StringBuilderNET ret = this;
        ...
        /// <param name="index"></param>
        /// <returns></returns>
        private StringBuilderNET FindChunkForByte(int byteIndex)
        {
        ...
        /// is a assumed to point at the chunk representing the whole StringBuilderNET) and search
        /// until it finds the current chunk (thus is O(n)).  So it is more expensive than a field fetch!
        /// </summary>
        private StringBuilderNET Next(StringBuilderNET chunk)
        {
            if (chunk == this)
                return null;
        ...
        private void ExpandByABlock(int minBlockCharCount)
        {
            ...
            m_ChunkPrevious = new StringBuilderNET(this);
        ...
        /// </summary>
        private StringBuilderNET(StringBuilderNET from)
        {
        ...
        /// </summary>
        [System.Security.SecuritySafeCritical]  // auto-generated
        private void MakeRoom(int index, int count, out StringBuilderNET chunk, out int indexInChunk, bool doneMoveFollowingChars)
        {
            VerifyClassInvariant();
            ...
            StringBuilderNET newChunk = new StringBuilderNET(Math.Max(count, DefaultCapacity), chunk.m_MaxCapacity, chunk.m_ChunkPrevious);
        ...
        /// </summary>
        private StringBuilderNET(int size, int maxCapacity, StringBuilderNET previousBlock)
        {
        ...
        /// </summary>
        [SecuritySafeCritical]
        private void Remove(int startIndex, int count, out StringBuilderNET chunk, out int indexInChunk)
        {
            VerifyClassInvariant();
            ...
            chunk = this;
            StringBuilderNET endChunk = null;
