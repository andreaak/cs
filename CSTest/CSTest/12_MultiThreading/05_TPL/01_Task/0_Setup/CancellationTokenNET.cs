...
namespace CSTest._12_MultiThreading._05_TPL._01_Task._0_Setup
{
    ...
    public struct CancellationTokenNET
    {
        ...
        private CancellationTokenSourceNET m_source;
        ...
        /// </remarks>
        public static CancellationTokenNET None
        {
            get { return default(CancellationTokenNET); }
        }
        ...
        /// </summary>
        internal CancellationTokenNET(CancellationTokenSourceNET source)
        {
            m_source = source;
        }
        ...
        /// </remarks>
        public CancellationTokenNET(bool canceled) :
            this()
        {
            if (canceled)
                m_source = CancellationTokenSourceNET.InternalGetStaticSource(canceled);
        }
        ...
        public CancellationTokenRegistrationNET Register(Action callback)
        {
            if (callback == null)
        ...
        /// be used to deregister the callback.</returns>
        /// <exception cref="T:System.ArgumentNullException"><paramref name="callback"/> is null.</exception>
        public CancellationTokenRegistrationNET Register(Action callback, bool useSynchronizationContext)
        {
            if (callback == null)
                throw new ArgumentNullException("callback");
        ...
        /// be used to deregister the callback.</returns>
        /// <exception cref="T:System.ArgumentNullException"><paramref name="callback"/> is null.</exception>
        public CancellationTokenRegistrationNET Register(Action<Object> callback, Object state)
        {
            if (callback == null)
                throw new ArgumentNullException("callback");
        ...
        /// <exception cref="T:System.ObjectDisposedException">The associated <see
        /// cref="T:System.Threading.CancellationTokenSource">CancellationTokenSource</see> has been disposed.</exception>
        public CancellationTokenRegistrationNET Register(Action<Object> callback, Object state, bool useSynchronizationContext)
        {
            return Register(
                callback,
                state,
        ...
        internal CancellationTokenRegistrationNET InternalRegisterWithoutEC(Action<object> callback, Object state)
        {
            return Register(
                callback,
                state,
        ...
        private CancellationTokenRegistrationNET Register(Action<Object> callback, Object state, bool useSynchronizationContext, bool useExecutionContext)
        {
            ...
            {
                return new CancellationTokenRegistrationNET(); // nothing to do for tokens than can never reach the canceled state. Give them a dummy registration.
            }
        ...
        public bool Equals(CancellationTokenNET other)
        {
            ...
            if (m_source == null)
            {
                return other.m_source == CancellationTokenSourceNET.InternalGetStaticSource(false);
            }

            if (other.m_source == null)
            {
                return m_source == CancellationTokenSourceNET.InternalGetStaticSource(false);
            }
        ...
        {
            if (other is CancellationTokenNET)
            {
                return Equals((CancellationTokenNET)other);
            }
        ...
        public override Int32 GetHashCode()
        {
            if (m_source == null)
            {
                ...
                return CancellationTokenSourceNET.InternalGetStaticSource(false).GetHashCode();
            }
        ...
        /// <exception cref="T:System.ObjectDisposedException">An associated <see
        /// cref="T:System.Threading.CancellationTokenSource">CancellationTokenSource</see> has been disposed.</exception>
        public static bool operator ==(CancellationTokenNET left, CancellationTokenNET right)
        {
        ...
        {
            throw new OperationCanceledException(EnvironmentNET.GetResourceString("OperationCanceled")/*, this*/);
        }

        private static void ThrowObjectDisposedException()
        {
            throw new ObjectDisposedException(null, EnvironmentNET.GetResourceString("CancellationToken_SourceDisposed"));
        }
        ...
        private void InitializeDefaultSource()
        {
            ...
            m_source = CancellationTokenSourceNET.InternalGetStaticSource(false);
        }
    }
}
#endif
