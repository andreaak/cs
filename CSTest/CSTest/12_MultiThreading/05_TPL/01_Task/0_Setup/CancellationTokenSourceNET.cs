...
namespace CSTest._12_MultiThreading._05_TPL._01_Task._0_Setup
{
    ...
    public class CancellationTokenSourceNET : IDisposable
    {
        //static sources that can be used as the backing source for 'fixed' CancellationTokens that never change state.
        private static readonly CancellationTokenSourceNET _staticSource_Set = new CancellationTokenSourceNET(true);
        private static readonly CancellationTokenSourceNET _staticSource_NotCancelable = new CancellationTokenSourceNET(false);
        ...
        private static readonly int s_nLists = (PlatformHelperNET.ProcessorCount > 24) ? 24 : PlatformHelperNET.ProcessorCount;
        ...
        private CancellationTokenRegistrationNET[] m_linkingRegistrations; //lazily initialized if required.
        ...
        {
            CancellationTokenSourceNET cts = source as CancellationTokenSourceNET;
        ...
        /// disposed.</exception>
        public CancellationTokenNET Token
        {
            get
            {
                ThrowIfDisposed();
                return new CancellationTokenNET(this);
            }
        }
        ...
        /// </summary>
        public CancellationTokenSourceNET()
        {
        ...
        private CancellationTokenSourceNET(bool set)
        {
        ...
        /// </para>
        /// </remarks>
        public CancellationTokenSourceNET(TimeSpan delay)
        {
        ...
        /// </para>
        /// </remarks>
        public CancellationTokenSourceNET(Int32 millisecondsDelay)
        {
        ...
        {
            CancellationTokenSourceNET cts = (CancellationTokenSourceNET)obj;
        ...
        {
            throw new ObjectDisposedException(null, EnvironmentNET.GetResourceString("CancellationTokenSource_Disposed"));
        }
        ...
        internal static CancellationTokenSourceNET InternalGetStaticSource(bool set)
        {
        ...
        /// </summary>
        internal CancellationTokenRegistrationNET InternalRegister(
        ...
        {
            if (AppContextSwitchesNET.ThrowExceptionIfDisposedCancellationTokenSource)
            {
                ThrowIfDisposed();
            }
            ...
            if (!IsCancellationRequested)
            {
                ...
                if (m_disposed && !AppContextSwitchesNET.ThrowExceptionIfDisposedCancellationTokenSource)
                    return new CancellationTokenRegistrationNET();
                ...
                CancellationTokenRegistrationNET registration = new CancellationTokenRegistrationNET(callbackInfo, addInfo);
        ...
        public static CancellationTokenSourceNET CreateLinkedTokenSource(CancellationTokenNET token1, CancellationTokenNET token2)
        {
            CancellationTokenSourceNET linkedTokenSource = new CancellationTokenSourceNET();

            bool token2CanBeCanceled = token2.CanBeCanceled;

            if (token1.CanBeCanceled)
            {
                linkedTokenSource.m_linkingRegistrations = new CancellationTokenRegistrationNET[token2CanBeCanceled ? 2 : 1]; // there will be at least 1 and at most 2 linkings
            ...
            if (token2CanBeCanceled)
            {
                ...
                {
                    linkedTokenSource.m_linkingRegistrations = new CancellationTokenRegistrationNET[1]; // this will be the only linking
                    index = 0;
                }
        ...
        public static CancellationTokenSourceNET CreateLinkedTokenSource(params CancellationTokenNET[] tokens)
        {
            if (tokens == null)
                throw new ArgumentNullException("tokens");

            if (tokens.Length == 0)
                throw new ArgumentException(EnvironmentNET.GetResourceString("CancellationToken_CreateLinkedToken_TokensIsEmpty"));
            ...
            CancellationTokenSourceNET linkedTokenSource = new CancellationTokenSourceNET();
            linkedTokenSource.m_linkingRegistrations = new CancellationTokenRegistrationNET[tokens.Length];
    ...
    internal class CancellationCallbackInfo
    {
        ...
        internal readonly CancellationTokenSourceNET CancellationTokenSource;
        ...
        internal CancellationCallbackInfo(
            ...
            CancellationTokenSourceNET cancellationTokenSource)
        {
            Callback = callback;
