...
namespace CSTest._10_Collections._02_GenericCollections._03_HashSet
{
    ...
    public class HashSetNET<T> : ICollection<T>, ISerializable, IDeserializationCallback, ISet<T>
    #if CS5
...
#endif
    {
        ...
        public HashSetNET(IEqualityComparer<T> comparer)
        {
            if (comparer == null)
            {
        ...
        public HashSetNET(IEnumerable<T> collection)
        ...
        public HashSetNET(IEnumerable<T> collection, IEqualityComparer<T> comparer)
            : this(comparer)
        {
            if (collection == null)
            {
            ...
            if ((m_count == 0 && m_slots.Length > HashHelpersNET.GetMinPrime()) ||
...
#if !SILVERLIGHT
        protected HashSetNET(SerializationInfo info, StreamingContext context)
        {
        ...
        public virtual void OnDeserialization(Object sender)
        {
            ...
            if (capacity != 0)
            {
                ...
                if (array == null)
                {
                    throw new SerializationException(SRNET.GetString(SRNET.Serialization_MissingKeys));
                }
        ...
        public void IntersectWith(IEnumerable<T> other)
        {
            ...
            if (otherAsCollection != null)
            {
                ...
                HashSetNET<T> otherAsSet = other as HashSetNET<T>;
        ...
        public void CopyTo(T[] array, int arrayIndex, int count)
        {
            ...
            if (arrayIndex < 0)
            {
                throw new ArgumentOutOfRangeException("arrayIndex", SRNET.GetString(SRNET.ArgumentOutOfRange_NeedNonNegNum));
            }
        ...
        public void TrimExcess()
        {
            ...
            else
            {
                ...
                int newSize = HashHelpersNET.GetPrime(m_count);
        ...
        /// </summary>
        /// <returns></returns>
        public static IEqualityComparer<HashSetNET<T>> CreateSetComparer()
        {
            return new HashSetEqualityComparerNET<T>();
        }
#endif
        ...
        private void Initialize(int capacity)
        {
            ...
            int size = HashHelpersNET.GetPrime(capacity);
        ...
        private void IncreaseCapacity()
        {
            ...
            int newSize = HashHelpersNET.ExpandPrime(m_count);
            if (newSize <= m_count)
            {
                throw new ArgumentException(SRNET.GetString(SRNET.Arg_HSCapacityOverflow));
            }
        ...
        {
            Contract.Assert(HashHelpersNET.IsPrime(newSize), "New size is not prime!");
        ...
        /// <param name="other"></param>
        /// <returns></returns>
        private bool IsSubsetOfHashSetWithSameEC(HashSetNET<T> other)
        {
        ...
        /// </summary>
        /// <param name="other"></param>
        private void IntersectWithHashSetWithSameEC(HashSetNET<T> other)
        {
            for (int i = 0; i < m_lastIndex; i++)
            {
                if (m_slots[i].hashCode >= 0)
        ...
        /// </summary>
        /// <param name="other"></param>
        private void SymmetricExceptWithUniqueHashSet(HashSetNET<T> other)
        {
            foreach (T item in other)
            {
                if (!Remove(item))
        ...
        private unsafe void SymmetricExceptWithEnumerable(IEnumerable<T> other)
        {
            ...
            BitHelperNET itemsToRemove;
            BitHelperNET itemsAddedFromOther;
            if (intArrayLength <= StackAllocThreshold / 2)
            {
                int* itemsToRemovePtr = stackalloc int[intArrayLength];
                itemsToRemove = new BitHelperNET(itemsToRemovePtr, intArrayLength);

                int* itemsAddedFromOtherPtr = stackalloc int[intArrayLength];
                itemsAddedFromOther = new BitHelperNET(itemsAddedFromOtherPtr, intArrayLength);
            }
            else
            {
                int[] itemsToRemoveArray = new int[intArrayLength];
                itemsToRemove = new BitHelperNET(itemsToRemoveArray, intArrayLength);

                int[] itemsAddedFromOtherArray = new int[intArrayLength];
                itemsAddedFromOther = new BitHelperNET(itemsAddedFromOtherArray, intArrayLength);
            }
        ...
        /// <param name="comparer"></param>
        /// <returns></returns>
        internal static bool HashSetEquals(HashSetNET<T> set1, HashSetNET<T> set2, IEqualityComparer<T> comparer)
        {
        ...
        /// <param name="set2"></param>
        /// <returns></returns>
        private static bool AreEqualityComparersEqual(HashSetNET<T> set1, HashSetNET<T> set2)
        {
        ...
        {
            private HashSetNET<T> set;
            private int index;
            private int version;
            private T current;

            internal Enumerator(HashSetNET<T> set)
            {
                this.set = set;
                index = 0;
            ...
            public bool MoveNext()
            {
                ...
                {
                    throw new InvalidOperationException(SRNET.GetString(SRNET.InvalidOperation_EnumFailedVersion));
                }
            ...
            Object System.Collections.IEnumerator.Current
            {
                get
                {
                    ...
                    {
                        throw new InvalidOperationException(SRNET.GetString(SRNET.InvalidOperation_EnumOpCantHappen));
                    }
                    return Current;
                }
            }
