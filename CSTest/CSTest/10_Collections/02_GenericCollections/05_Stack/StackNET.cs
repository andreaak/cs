...
namespace CSTest._10_Collections._02_GenericCollections._05_Stack
{
        ...
        IReadOnlyCollection<T>
    {
        ...
        public StackNET(IEnumerable<T> collection)
        {
            if (collection == null)
        ...
        {
            if (_size == 0)
                ThrowHelperNET.ThrowInvalidOperationException(ExceptionResourceNET.InvalidOperation_EmptyStack);
        ...
        {
            private StackNET<T> _stack;
            private int _index;
            private int _version;
            private T currentElement;

            internal Enumerator(StackNET<T> stack)
            {
                _stack = stack;
            ...
            {
                bool retval;
                if (_version != _stack._version) ThrowHelperNET.ThrowInvalidOperationException(ExceptionResourceNET.InvalidOperation_EnumFailedVersion);
                if (_index == -2)
            ...
            public T Current
            {
                get
                {
                    if (_index == -2) ThrowHelperNET.ThrowInvalidOperationException(ExceptionResourceNET.InvalidOperation_EnumNotStarted);
                    if (_index == -1) ThrowHelperNET.ThrowInvalidOperationException(ExceptionResourceNET.InvalidOperation_EnumEnded);
