...
namespace CSTest._10_Collections._02_GenericCollections._02_Dictionary
{
    ...
    public abstract class EqualityComparerNET<T> : IEqualityComparer, IEqualityComparer<T>
    {
        static volatile EqualityComparerNET<T> defaultComparer;

        public static EqualityComparerNET<T> Default
        {
            get
            {
                Contract.Ensures(Contract.Result<EqualityComparerNET<T>>() != null);

                EqualityComparerNET<T> comparer = defaultComparer;
                if (comparer == null)
                {
        ...
        private static EqualityComparerNET<T> CreateComparer()
        {
            //Contract.Ensures(Contract.Result<EqualityComparerNET<T>>() != null);
            ...
            //if (t == typeof(byte))
            //{
            //    return (EqualityComparerNET<T>)(object)(new ByteEqualityComparer());
            //}
            //// If T implements IEquatable<T> return a GenericEqualityComparer<T>
            //if (typeof(IEquatable<T>).IsAssignableFrom(t))
            //{
            //    return (EqualityComparerNET<T>)RuntimeTypeHandle.CreateInstanceForAnotherGenericParameter((RuntimeType)typeof(GenericEqualityComparer<int>), t);
            //}
            ...
            //    {
            //        return (EqualityComparerNET<T>)RuntimeTypeHandle.CreateInstanceForAnotherGenericParameter((RuntimeType)typeof(NullableEqualityComparer<int>), u);
            //    }
            //}
            ...
            //            return (EqualityComparerNET<T>)RuntimeTypeHandle.CreateInstanceForAnotherGenericParameter((RuntimeType)typeof(ShortEnumEqualityComparer<short>), t);
            //        case TypeCode.SByte:
            //            return (EqualityComparerNET<T>)RuntimeTypeHandle.CreateInstanceForAnotherGenericParameter((RuntimeType)typeof(SByteEnumEqualityComparer<sbyte>), t);
            //        case TypeCode.Int32:
            //        case TypeCode.UInt32:
            //        case TypeCode.Byte:
            //        case TypeCode.UInt16: //ushort
            //            return (EqualityComparerNET<T>)RuntimeTypeHandle.CreateInstanceForAnotherGenericParameter((RuntimeType)typeof(EnumEqualityComparer<int>), t);
            //        case TypeCode.Int64:
            //        case TypeCode.UInt64:
            //            return (EqualityComparerNET<T>)RuntimeTypeHandle.CreateInstanceForAnotherGenericParameter((RuntimeType)typeof(LongEnumEqualityComparer<long>), t);
            //    }
            //}
    ...
    [Serializable]
    internal class GenericEqualityComparer<T> : EqualityComparerNET<T> where T : IEquatable<T>
    {
        [Pure]
    ...
    [Serializable]
    internal class NullableEqualityComparer<T> : EqualityComparerNET<Nullable<T>> where T : struct, IEquatable<T>
    {
        [Pure]
    ...
    [Serializable]
    internal class ObjectEqualityComparer<T> : EqualityComparerNET<T>
    {
        [Pure]
        public override bool Equals(T x, T y)
        {
    ...
    [Serializable]
    internal class ByteEqualityComparer : EqualityComparerNET<byte>
    {
        [Pure]
        ...
        internal /*unsafe*/ override int IndexOf(byte[] array, byte value, int startIndex, int count)
        {
            ...
            if (count < 0)
                throw new ArgumentOutOfRangeException("count", EnvironmentNET.GetResourceString("ArgumentOutOfRange_Count"));
            if (count > array.Length - startIndex)
                throw new ArgumentException(EnvironmentNET.GetResourceString("Argument_InvalidOffLen"));
    ...
    [Serializable]
    internal class EnumEqualityComparer<T> : EqualityComparerNET<T>, ISerializable where T : struct
    {
        [Pure]
        public override bool Equals(T x, T y)
        {
            int x_final = JitHelpersNET.UnsafeEnumCast(x);
            int y_final = JitHelpersNET.UnsafeEnumCast(y);
        ...
        public override int GetHashCode(T obj)
        {
            int x_final = JitHelpersNET.UnsafeEnumCast(obj);
    ...
    [Serializable]
    internal sealed class LongEnumEqualityComparer<T> : EqualityComparerNET<T>, ISerializable where T : struct
    {
        [Pure]
        public override bool Equals(T x, T y)
        {
            long x_final = JitHelpersNET.UnsafeEnumCastLong(x);
            long y_final = JitHelpersNET.UnsafeEnumCastLong(y);
            return x_final == y_final;
        }
        ...
        public override int GetHashCode(T obj)
        {
            long x_final = JitHelpersNET.UnsafeEnumCastLong(obj);
            return x_final.GetHashCode();
        }
    ...
    internal sealed class RandomizedStringEqualityComparer : IEqualityComparer<String>, IEqualityComparer, IWellKnownStringEqualityComparer
    {
        ...
        IEqualityComparer IWellKnownStringEqualityComparer.GetEqualityComparerForSerialization() {
            return EqualityComparerNET<string>.Default;
        } 
    }
