...
public partial class DataLog
{
	...
	[Column(Storage="_entityDescription", Name="EntityDescription", DbType="TEXT", AutoSync=AutoSync.Never)]
	[DebuggerNonUserCode()]
	...
	[Column(Storage="_entityID", Name="EntityId", DbType="INTEGER", AutoSync=AutoSync.Never)]
	[DebuggerNonUserCode()]
	public int EntityID
	{
		get
	...
	[Column(Storage="_operation", Name="Operation", DbType="TEXT", AutoSync=AutoSync.Never)]
	[DebuggerNonUserCode()]
